...
sealed class AgslPoints(val point: String, val images: ShaderPointsImage) {
    ...
    data object WhyAGSL2 : AgslPoints("helps build custom UI", ShaderPointsImage(R.raw.simulation, R.raw.blue_circle))
    ...
    data object ColorSpace : AgslPoints(
        "GLSL uses RGB while Android uses SRGB", ShaderPointsImage(R.raw.shadelang, null)
    )
